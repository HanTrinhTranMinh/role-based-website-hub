...
const Dashboard = () => {
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">Massage toàn thân - Ngày mai 14:00</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-4">
                    <div className="w-2 h-2 bg-green-500 rounded-full mt-2"></div>
                    <div>
                      <p className="text-sm font-medium">Khuyến mãi mới</p>
                      <p className="text-xs text-muted-foreground">Giảm 30% cho dịch vụ chăm sóc da</p>
                    </div>
                  </div>
                </div>
              </CardContent>
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">Nguyễn Thị Lan - 0987654321</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-4">
                    <div className="w-2 h-2 bg-green-500 rounded-full mt-2"></div>
                    <div>
                      <p className="text-sm font-medium">Thanh toán hoàn tất</p>
                      <p className="text-xs text-muted-foreground">Hóa đơn #2024110 - 1.500.000 VNĐ</p>
                    </div>
                  </div>
                </div>
              </CardContent>
  ...
  return getDashboardContent(user?.role || '');
};
